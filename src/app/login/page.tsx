...
export const metadata: Metadata = {
  title: "Sign in",
  description: "Sign in to your Royal Prime Logistics account to manage shipments and collections.",
  ...
  return (
    <AuthShell
      ...
      aside={{
        ...
        attribution: "Royal Prime operations",
      }}
      footer={
